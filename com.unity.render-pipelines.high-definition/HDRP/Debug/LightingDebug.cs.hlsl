...
#define DEBUGSCREENSPACETRACING_WEIGHT (6)
#define DEBUGSCREENSPACETRACING_HI_ZITERATION_COUNT (7)
#define DEBUGSCREENSPACETRACING_HI_ZINTERSECTION_KIND (8)
#define DEBUGSCREENSPACETRACING_HI_ZHIT_WEIGHT (9)
#define DEBUGSCREENSPACETRACING_LINEAR_ITERATION_COUNT (10)
#define DEBUGSCREENSPACETRACING_LINEAR_HIT_WEIGHT (11)
