...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    partial class HDProbeUI
    {
        ...
        static readonly GUIContent fieldCaptureTypeContent = CoreEditorUtils.GetContent("Type");
        static readonly GUIContent resolutionContent = CoreEditorUtils.GetContent("Resolution");
        ...
        static readonly GUIContent useOcclusionCullingContent = CoreEditorUtils.GetContent("Use Occlusion Culling");
        static readonly GUIContent nearClipCullingContent = CoreEditorUtils.GetContent("Near Clip");
        static readonly GUIContent farClipCullingContent = CoreEditorUtils.GetContent("Far Clip");
        ...
        static GUIContent[] influenceToolbar_Contents
        {
            get
            {
        ...
        static GUIContent[] captureToolbar_Contents
        {
            get
            {
